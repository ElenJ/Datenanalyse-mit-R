...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 110 }, { marker: 'pandoc', elapsed: 81 }, { marker: 'post-processor', elapsed: 4 }, { marker: 'pre-processor', elapsed: 7 }, { marker: 'render', elapsed: 342 } ];
