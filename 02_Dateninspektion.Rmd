...
### 2.x Ausreißer
Ausreißer können ihre gesamte Analyse zunichte machen, weshalb Sie die Daten daraufhin unbedingt prüfen müssen.
Strenggenommene Ausreißer: unter Q(1/4)−3/2 IQR oder über Q(3/4)+3/2 IQR
Untersuchung von Datenpunkten, die auf ein Datenmodell große Wert ausübten: Cooks Distanz
Ausreißerbehandlung: 
